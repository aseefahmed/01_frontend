<?php $__env->startSection('page_title', 'Buyers'); ?>

<?php $__env->startSection('content'); ?>
    <div class="row col-sm-12">
        <h3 class="heading"><?php echo $__env->yieldContent('page_title'); ?></h3>
    </div>
    <div class="row" ng-controller="BuyerController" ng-cloak>
        <div class="col-sm-12 col-md-12">
                                    ...
                                    <table class="table table-responsive table-bordered table-striped">
                                        ...
                                        <tr ng-if="buyers.length == 0 || filtered.length == 0">
                                            ...
                                            <tr dir-paginate="buyer in filtered = (buyers| orderBy : sortKey : reverse | filter : search_filter  | itemsPerPage : num_of_items) " ng-cloak>
                                                ...
                                                <td ng-cloak><img src="<?php echo e(asset('img/uploads/production/buyers')); ?>/## buyer.image ##" width="80px"/></td>
                                                ...
                                                <td  ng-cloak align="center">
                                                    <a class="btn btn-primary" href="<?php echo e(url('production/buyers/')); ?>/## buyer.id ##"><i class="glyphicon glyphicon-eye-open" class="view_buyer_btn"></i></a>&nbsp;
                                                    <a ng-if="buyer.user_id == <?php echo e(Auth::user()->id); ?>" class="btn btn-danger" ng-click="remove_buyer(buyer.id, buyer.buyer_name, 'single_delete')" buyer_name="## buyer.name ##" buyer_id="## buyer.id ##"><i class="glyphicon glyphicon-trash"></i></a>
                                                </td>
                                            </tr>
            ...
            <div class="col-sm-4">
                <?php echo $__env->make('production::partials.orders_stats', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            </div>
