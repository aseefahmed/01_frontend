    ...
    <div class="navbar-inner">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav user_menu pull-right">
                ...
                <li class="divider-vertical hidden-sm hidden-xs"></li>
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="img/user_avatar.png" alt="" class="user_avatar"><?php echo e(Auth::user()->first_name); ?> <?php echo e(Auth::user()->last_name); ?> <b class="caret"></b></a>
                    <ul class="dropdown-menu dropdown-menu-right">
