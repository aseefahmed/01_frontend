<?php $__env->startSection('page_title', 'Report: Orders'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row" ng-controller="OrderController" ng-cloak>
        <div>
            <?php echo $__env->make('production::partials.advanced_order_search_form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        </div>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <table class="table table-responsive table-bordered table-striped">
                                        ...
                                        <tr dir-paginate="order in filtered = (orders| orderBy : sortKey : reverse | filter : search_filter  | itemsPerPage : num_of_items) " ng-cloak>
                                            <td>## $index+1 ##</td>
                                            <td ng-cloak><img src="<?php echo e(asset('img/uploads/production/styles')); ?>/## order.style_image ##" width="80px"/></td>
